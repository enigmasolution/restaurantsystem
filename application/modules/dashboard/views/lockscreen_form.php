...
<html lang="en" class="no-js">
	...
	<head>
        ...
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/less/styles.less">
	...
	<body class="lock-screen">
		<div class="main-ls">
			...
			<div class="box-ls">
				<img alt="" src="<?php echo base_url() ?>assets/admin/images/avatar-1-xl.jpg"/>
				<div class="user-info">
					<h1><i class="fa fa-lock"></i> Peter Clark</h1>
