                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">Restaurant</span> <small>Registration</small>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                    <form role="form"  id="form_sample_1" action="<?php echo site_url('restaurant/addrestaurant') ?>" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                        <div class="form-body">
                                       ...
                                       <div class="col-md-6">     
                                            <div class="form-group">
                                                <label>Restaurant Name <span class="required" aria-required="true"> * </span></label>
                                                     <input name="rest_name" type="text" value="<?php echo set_value('rest_name') ?>" class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                Contact Person <span class="required" aria-required="true"> * </span>
                                                    ...
                                                    <input name="rest_contactperson" type="text" value="<?php echo set_value('rest_contactperson') ?>" class="form-control">
                                            ...
                                            <div class="form-group">
                                                <label>Contact # <span class="required" aria-required="true"> * </span>
                                                    ...
                                                    <input name="rest_contactno" value="<?php echo set_value('rest_contactno') ?>" type="text" class="form-control">
                                        ...
                                        <div class="col-md-6">      
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="cityid">
                                                  ...
                                                  <?php foreach($cities_record->result() as $city){?>
                                                     <option value="<?php echo $city->cityid ?>" <?php if(set_value('cityid')==$city->cityid){echo 'selected="selected"';} ?>><?php echo $city->ci_name ?></option>
                                                  <?php }?>
                                              </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                Restaurant Address <span class="required" aria-required="true"> * </span>
                                                   ...
                                                   <textarea name="rest_address" class="form-control" ><?php echo set_value('rest_address') ?></textarea>
                                            ...
                                            <div class="form-group">
                                                <label>
                                                 Restaurant Description <span class="required" aria-required="true"> * </span>
                                                    ...
                                                    <textarea name="rest_description" class="form-control" ><?php echo set_value('rest_description') ?></textarea>
