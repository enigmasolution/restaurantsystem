...
public function get_login($palo_username, $palo_password){
		...
		$this->db->select('parentlogin.parentloginid, parents.pa_fathername,parents.parentid, parents.pa_parentaccountno, parents.pa_avator, parentlogin.studentid');
...
function update_password_byusername($parentloginid, $palo_correntpassword, $palo_newpassword){   
		$hash_passnew="password('".$palo_newpassword."')";
		$hash_passold="password('".$palo_correntpassword."')";		
		$this->db->where('palo_password',$hash_passold, FALSE);
		$this->db->where('parentloginid',$parentloginid);
		$this->db->set('palo_password',$hash_passnew, FALSE);
...
function get_students_byparentaccountno($where_array){
	   ...
	   $this->db->join('academicsession','students.academicsessionid=academicsession.academicsessionid','left');
