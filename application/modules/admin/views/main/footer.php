        ...
        <div class="page-footer">
            <div class="page-footer-inner"> <?php date('Y')?> &copy; Restaurant System.
                <a href="http://themeforest.net/item/metronic-responsive-admin-dashboard-template/4021469?ref=keenthemes" title="Purchase Metronic just for 27$ and get lifetime updates for free" target="_blank">Purchase Now !</a>
            </div>
...
<![endif]-->
        ...
        <script src="<?php echo base_url() ?>assets/pages/scripts/form-validation.js" type="text/javascript"></script>
         <script src="<?php echo base_url() ?>assets/pages/scripts/functions.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL SCRIPTS -->
