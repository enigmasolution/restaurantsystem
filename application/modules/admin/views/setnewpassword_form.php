...
<html lang="en" class="no-js">
    ...
    <div class="main-login col-sm-4 col-sm-offset-4">
		...
		<div class="main-login col-sm-4 col-sm-offset-4">
                                <?php if(isset($msg)) {?>   
                               <div class="alert alert-danger alert-dismissable"> <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><strong>Success !</strong>&emsp;<?php echo $msg; ?></div>		
		                          <?php } ?>
			<div class="logo">
           Social School
			</div>
			...
			<div class="box-login" style="display:<?php if($hint=='login' || $hint==''){echo 'block';}else{echo 'none';} ?>">
				<h3>Sign in to your account</h3>
				<p>
					Please enter your username and password to log in.
				</p>
                <form class="form-login" action="<?php echo site_url('admin/login')  ?>" method="post">
					<input type="hidden" name="hint" value="login">
					...
					<fieldset>
						<div class="form-group">
							<span class="input-icon">
                                ...
                                <span class="alertrequired"><?php echo form_error('username'); ?></span>
						</div>
						<div class="form-group">
							<span class="input-icon">
            ...
            <!-- start: FORGOT BOX -->
			<div class="box-forgot" style="display:<?php if($hint=='forgetpassword'){echo 'block';}else{echo 'none';} ?>">
